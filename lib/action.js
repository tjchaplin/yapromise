...
(function(exports){
	...
	Action.prototype.execute = function(){
		...
		console.log("after executable"+JSON.stringify(result));
	...
	Action.prototype.onComplete = function(value){
		...
		{
			console.log("Set self to returned action");
			self = value;
		}	
	    ...
	    process.nextTick(function(){
	    	...
	    	self.next.addAction(
	    		function(value){
					...
					newAction.executable = onComplete;
					newAction.execute(value);
					return value;
	    		},
		    	function(error){
	    			console.log("calling newAction onError");	
					newAction.executable = onError
					newAction.execute(error);
					return error;
		    	});
