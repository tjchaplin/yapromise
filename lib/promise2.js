...
if (typeof setImmediate === "function")
	...
	module.exports.create = function(promise){
		return new Promise(promise);
	};

	module.exports.pending = function(promise){
		return new Promise(promise).pending;
	};

	module.exports.rejected = function(promise){
		return new Promise(promise).rejected;
	};

	module.exports.fulfilled = function(promise){
		return new Promise(promise).fulfilled;
	};
